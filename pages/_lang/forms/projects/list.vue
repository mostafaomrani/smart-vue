  ...
  <div id="pageTable">
    <v-container grid-list-xl fluid>
      <v-layout row wrap>
        ...
        <v-flex sm6>
          <h3>{{$t('project.pagetitle')}}</h3>
        </v-flex>

        <v-flex sm6 class="text-left">
          <v-btn color="primary" dark :to="'/' + $i18n.locale +  '/forms/projects/create'" target="_self">
        ...
        <v-flex sm12 lg12>
          <v-card>
            <div class="p-all-5">{{$t('organization.select')}}</div>
            <v-select
              class="p-all-5"
              @change="change($event)"
