  ...
  <div id="pageDashboard">
    <v-container grid-list-xl fluid>
      <v-layout row wrap>
        ...
        <v-flex lg3 sm6 xs12>
          <mini-statistic icon="fa fa-university" title="100+" :sub-title="$t('general.organization')" color="indigo"></mini-statistic>
        </v-flex>
        <v-flex lg3 sm6 xs12>
          <mini-statistic icon="fa fa-connectdevelop" title="150+" :sub-title="$t('general.project')" color="red"></mini-statistic>
        </v-flex>
        <v-flex lg3 sm6 xs12>
          <mini-statistic
            icon="fa fa-user-o"
            title="200+"
            :sub-title="$t('general.client')"
            color="light-blue"
          ></mini-statistic>
        </v-flex>
        <v-flex lg3 sm6 xs12>
          <mini-statistic icon="fa fa-mobile" title="50+" :sub-title="$t('general.device')" color="purple"></mini-statistic>
        </v-flex>
        <!-- mini statistic  end -->
        <v-flex lg8 sm12 xs12>
          <v-widget :title="$t('general.traffic')" content-bg="white">
        ...
        <v-flex lg4 sm12 xs12>
          <v-widget :title="$t('general.visits')" content-bg="white">
            <div slot="widget-content">
              <e-chart
                :path-option="[
